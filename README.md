...
## Verify example cost report
* http://localhost:8080/customers/1/cost-report

You should see result for the example cost report for customer 1. The application is working and connected to the H2 database.
